 ...
 *  @author Kevin Wayne
 *  Edited By Fredrik Arvidsson 2018 for Project PictureEditorFAO - added getImage() and force Fileformat in save
 *  
 */
public final class Picture implements ActionListener {
   ...
   /**
    ...
    //Added by Fredrik Arvidsson for project
   ...
   /**
    ...
    public void save(File file) {
        ...
        if ("gif".equalsIgnoreCase(suffix) ||"jpg".equalsIgnoreCase(suffix) || "png".equalsIgnoreCase(suffix)) {
            try {
        ...
        //This "else" was added by Fredrik Arvidsson
        else {
        	File output = new File(file.getAbsolutePath() + ".jpg");
        	suffix = "jpg";
        	try {
   ...
   /**
    ...
    /*public static void main(String[] args) {
        ...
        for(int i=0;i<500;i++)
        	for(int u=0;u<500;u++)
        		picture.set(i, u, new Color((int)(Math.random()*255),(int)(Math.random()*255),(int)(Math.random()*255)));
        picture.show();
